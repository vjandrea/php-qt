...
# Launch kalyptus
chdir "../smoke/plasma";
system "perl -I@kdebindings_SOURCE_DIR@/kalyptus @kdebindings_SOURCE_DIR@/kalyptus/kalyptus @ARGV --qt4 --globspace -fsmoke --name=qt $macros --no-cache --outputdir=$outdir @headers @plasmaheaders";
my $exit = $? >> 8;
exit $exit if ($exit);
chdir "$kalyptusdir";
